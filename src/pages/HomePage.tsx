...
const HomePage: React.FC = () => {
  ...
  return (
    <PageLayout className="site-page home-page">
      {/* Hero Section */}
      <section className="editorial-hero app-hero hero" id="home">
        <div className="app-hero__grid hero-content">
          <div className="hero-image">
            ...
            <div className="glass-panel glass-panel--light cta-section">
              ...
              <div className="cta-buttons">
                <a href={createSitePath('/framework')} className="button-primary button-primary--light btn-primary">Explore Framework</a>
                <a href={createSitePath('/product')} className="button-secondary btn-secondary">View Methodology</a>
              </div>
            </div>
          </div>
          <div className="hero-text">
            <div className="title-section">
              <h1 className="editorial-hero__title">I am the Chief Archeologist</h1>
            ...
            <div className="bio-content">
              <p className="glass-panel glass-panel--deep intro-paragraph">
              ...
              <div className="experience-highlights">
                <div className="glass-panel glass-panel--light highlight-item">
